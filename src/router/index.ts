...
const routes: RouteRecordRaw[] = [
  ...
  { path: '/listings/create', name: 'listing-create', component: () => import('../features/listings/ListingCreateView.vue'), meta: { requiresAuth: true } },
  ...
  { path: '/listings/:id/edit', name: 'listing-edit', component: () => import('../features/listings/ListingEditView.vue'), meta: { requiresAuth: true } },
  ...
  { path: '/matches/:id', name: 'match-detail', component: () => import('../views/MatchDetailView.vue'), meta: { requiresAuth: true } },
  ...
  { path: '/moderation', name: 'moderation', component: () => import('../features/moderation/ModerationQueueView.vue'), meta: { requiresAuth: true, requiresModeration: true } },
  { path: '/moderation/kyc', name: 'moderation-kyc', component: () => import('../features/moderation/KycQueueView.vue'), meta: { requiresAuth: true, requiresModeration: true } },
