...
- **Public Chrome & Landing Module (`src/features/landing/`):**
  ...
  - Section components under `src/features/landing/sections/` compose the 12 sections:
    - **Hero Section (`HeroSection.vue`, `#hero`):** Two-column responsive layout with 48×48 brand mark («چک»), RTL accent bar, pilot badge, and a static schematic preview panel.
